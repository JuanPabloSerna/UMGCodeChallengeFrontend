...
describe('SearchPage', () => {
  ...
  describe('form submission', () => {
    ...
    it('should submit form with valid ISRC', async () => {
      ...
      vi.spyOn(apiClient, 'createTrack').mockResolvedValue(mockTrack)
      ...
      expect(apiClient.createTrack).toHaveBeenCalledWith('USRC17607839')
      expect(apiClient.getCoverUrl).toHaveBeenCalledWith('USRC17607839')
    })
  })

  describe('successful track creation', () => {
    it('should display track information after successful creation', async () => {
      const mockTrack = {
        name: 'Test Song',
        artistName: 'Test Artist',
        albumName: 'Test Album',
